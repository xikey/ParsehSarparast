 ...
 */
public class GroupTSInfoAdapter extends RecyclerView.Adapter<GroupTSInfoAdapter.productoViewHolder>{
    ...
    public GroupTSInfoAdapter(ArrayList<UserInfo> item) {
        this.item = item;
    }
        ...
        public productoViewHolder(final View itemView) {
            ...
            lyRoot.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(activity,ActivityListOfTSGroupInfo.class);
