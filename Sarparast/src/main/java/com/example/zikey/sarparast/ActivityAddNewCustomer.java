...
//        Log.e("Permission","Permison is "+permissionCheck);
        ...
        txtShopName = (EditText) findViewById(R.id.edtShopName);
        ...
        txtCodeMelli = (EditText) findViewById(R.id.edtCodeMelli);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (temp.equals("...")) {
                    ...
                    nationalCode = txtCodeMelli.getText().toString();
    ...
    public class AddNewCustomerAsync extends AsyncTask<Void, String, String> {
        ...
        protected void onPostExecute(String state) {
            ...
            if (state.equals("Null")) {
                new AlertDialog.Builder(ActivityAddNewCustomer.this)
                        .setCancelable(false)
                        .setTitle("خطا")
                        .setMessage("خطا در ثبت مشتری , از اعداد فارسی استفاده ننمایید ")
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                finish();
                            }
        ...
        protected String doInBackground(Void... voids) {
            ...
            datas.put("nationalCode", nationalCode);

            if (isonline) {
                try {

                    SoapObject request2 =  NetworkTools.CallSoapMethod("http://" + preferenceHelper.getString(NetworkTools.URL), "S_ADD_new_Customer", datas);
