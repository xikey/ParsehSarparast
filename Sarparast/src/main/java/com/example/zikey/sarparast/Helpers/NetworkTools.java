...
public class NetworkTools {
    ...
    public static boolean checkNetworkConnection(FragmentActivity activity) {
        ...
        if (cm.getActiveNetworkInfo() == null) {
            ...
            alertDialog.setMessage("اتصال به اینترنت امکان پذیر نمی باشد");
